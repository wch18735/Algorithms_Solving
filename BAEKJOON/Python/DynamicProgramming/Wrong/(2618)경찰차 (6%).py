...
def dfs(idx):
    ...
    # car1 is closer
    if abs(car1[0] - num_list[idx][0]) + abs(car1[1] - num_list[idx][1]) < \
            abs(car2[0] - num_list[idx][0]) + abs(car2[1] - num_list[idx][1]):
    ...
    # car2 is closer
    elif abs(car1[0] - num_list[idx][0]) + abs(car1[1] - num_list[idx][1]) > \
            abs(car2[0] - num_list[idx][0]) + abs(car2[1] - num_list[idx][1]):
